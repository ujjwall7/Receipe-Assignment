# Generated by Django 4.2.16 on 2024-10-29 05:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('creator', 'Creator'), ('viewer', 'Viewer')], default='viewer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(to='master.ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='Favourite',
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.recipe')),
